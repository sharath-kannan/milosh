...
describe('Log Web Vitals', () => {
  // before(() => {
  //   document.body.innerHTML = '<div id="web-vitals"></div>';
  // });
  // beforeEach(() => {
  //   sinon.spy(window.lana, 'log');
  // });
  it('Loads lana.js upon calling lana.log the first time', (done) => {
    window.lana = {
      log: (logStr, logOpts) => {
