...
`,F=()=>{let c=[A`
    ...
    `),c};var[j,U,V,W,G,He]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var K=document.createElement("style");K.innerHTML=`
:root {
